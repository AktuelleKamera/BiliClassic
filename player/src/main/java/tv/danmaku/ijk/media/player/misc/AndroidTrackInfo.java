...
public class AndroidTrackInfo implements ITrackInfo {
    ...
    public IMediaFormat getFormat() {
        ...
        try {
            java.lang.reflect.Method method = android.media.MediaPlayer.TrackInfo.class.getMethod("getFormat");
            android.media.MediaFormat format = (android.media.MediaFormat) method.invoke(mTrackInfo);
            if (format == null)
                return null;
