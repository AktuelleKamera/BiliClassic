...
BT-5 弹幕引擎为本项目原创，专为 ARMv5TE / ARMv6 等无 VFP 设备设计。通过预渲染 Bitmap、同文案去重、低帧率轮询和 `MIN_PRIORITY` 后台线程，尝试将弹幕渲染对视频解码的干扰降到最低。然而我还是推荐你用DanmakuFlameMaster（
...
本项目的目标设备是 2011 年前后的移动设备，包括但不限于：
